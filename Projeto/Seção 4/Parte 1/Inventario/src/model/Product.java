...
public class Product {
	...
	/**
	 * Declarando construtor com parametros que recebera por meio de
	 * argumentos, os valores para inicializar as variaveis de campo.
	 * @param productCode
	 * @param productName
	 * @param productAmount
	 * @param productPrice
	 ...
	 * se não for, é lançado uma exception que é capturada pelo bloco catch e imprime
	 * a mensagem referente ao tipo da exception.
	 * @param amount
	 */
